...
public partial class LoginForm : Form
{
    ...
    public LoginForm()
    {
        ...
        _auth = new PrimeAuth("your-api-key-here", "1.0.0", "https://your-replit-url.replit.dev/api/v1");
    }

    private void InitializeComponent()
    {
        this.Text = "PrimeAuth Login";
...
public partial class RegisterForm : Form
{
    ...
    public RegisterForm(PrimeAuth auth)
    {
        _auth = auth;
        InitializeComponent();
    }
