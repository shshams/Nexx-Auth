      ...
      <div className="relative z-10 max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 pt-24">
        ...
        <div className="mb-8">
          <div className="text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Complete integration guide for Prime Auth API. All code examples are personalized with your actual API keys and settings.
            </p>
          </div>
        </div>
        ...
        <Card className="phantom-card mb-8">
          <CardHeader>
            ...
            <CardDescription>
              Get up and running with Prime Auth in 5 minutes using your personalized settings
            </CardDescription>
          </CardHeader>
          <CardContent>
  ...
  "session_token": "token_here"
        ...
        <Card className="phantom-card">
          <CardHeader>
            ...
            <CardDescription>
              Best practices for implementing Prime Auth
            </CardDescription>
          </CardHeader>
          <CardContent>
