        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <span className="text-xl font-bold text-foreground">Prime Auth</span>
            </div>
      ...
      <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 pt-24">
        ...
        <div className="mb-8">
          <div className="text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Complete integration guide for Prime Auth API. Learn how to implement secure authentication in your C# WinForms applications with HWID locking, version control, and blacklist management.
            </p>
          </div>
        </div>
        ...
        <Card className="phantom-card mb-8">
          <CardHeader>
            ...
            <CardDescription>
              Get up and running with Prime Auth in 5 minutes
            </CardDescription>
          </CardHeader>
          <CardContent>
...
// - Application-specific: Only affects your application`}
        ...
        <Card className="phantom-card">
          <CardHeader>
            ...
            <CardDescription>
              Important security considerations when using Prime Auth
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
