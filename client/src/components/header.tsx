...
import { Shield, FileText, Users, DollarSign, LogIn, LogOut, Settings, Webhook, Ban, Home, Moon, Sun, Activity, Code, Crown, UserCog, MoreHorizontal, User } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              ...
              <Link href="/users">
                <Button variant={location === "/users" ? "default" : "ghost"} size="sm">
